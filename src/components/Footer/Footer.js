...
const socialLinks = [
  { link: "https://twitter.com/kitjacky", name: "Twitter", icon: twitterIcon },
  { link: "https://medium.com/jackykit", name: "Medium", icon: mediumIcon },
  { link: "https://github.com/JK-Network", name: "Github", icon: githubIcon },
